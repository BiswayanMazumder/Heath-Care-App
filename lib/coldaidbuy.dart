...
class coldaidbuy extends StatefulWidget {
  const coldaidbuy({Key? key}) : super(key: key);

  @override
  State<coldaidbuy> createState() => _coldaidbuyState();
}

class _coldaidbuyState extends State<coldaidbuy> {
    ...
    return new Scaffold(
      ...
      body: new Column(
        children: [
          ...
          new Text('Welcome To Buy Coldaid',style:
          new TextStyle(
              fontSize: 20,
