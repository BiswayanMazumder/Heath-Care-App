...
import 'package:umail/doloaddress.dart';
import 'package:umail/main.dart';
class dolocards extends StatefulWidget {
  const dolocards({Key? key}) : super(key: key);

  @override
  State<dolocards> createState() => _dolocardsState();
}

class _dolocardsState extends State<dolocards> {
    ...
    return new Scaffold(
      ...
      body: new Column(
        children: [
          ...
          new Text('Welcome To Buy Dolo 650',style:
          new TextStyle(
              fontSize: 20,
          ...
          Align(
            ...
            child: new ElevatedButton(onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>doloaddresses()));
            },
